---
title: Custom Enchantments for PaperMC Plugins | Reedwork
...
The `CustomEnchantment` implementation then provides the properties used to construct the corresponding Paper enchantment registry entry.
...
## Configure the Paper plugin bootstrapper
...
<Code title="paper-plugin.yml" lang="yaml" mark="bootstrapper" code={`
