...
<CardGrid stagger>
    ...
    <AstroIconLinkCard title="Brigadier Integration" href="/features/commands/#automatic-brigadier-argument-mapping" icon="mdi:lightning-bolt">
    ...
    <AstroIconLinkCard title="Custom Suggestions" href="/features/commands/#custom-command-suggestions" icon="mdi:lightbulb-on-outline">
        Add application-specific command suggestions using suggestion providers and Reedwork's dependency injection system.
    </AstroIconLinkCard>

    <AstroIconLinkCard title="Automatic Usage Generation" href="/features/commands/#command-usage" icon="mdi:account-help">
        Generate command usage information automatically from the structure of your registered commands.
    </AstroIconLinkCard>

    <AstroIconLinkCard title="Developer Utilities" href="/utilities/" icon="mdi:help-outline">
...
<LinkButton icon="right-arrow" href="/getting-started/introduction/">Get started with Reedwork</LinkButton>
<LinkButton icon="external" iconPlacement="end" href="https://github.com/ReedworkMC/Reedwork" variant="secondary">View Reedwork on GitHub</LinkButton>
